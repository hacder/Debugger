...
public class OkhttpSet {
    ...
    private TimeUnit timeUnit = TimeUnit.MILLISECONDS;//超时时间单位,默认为妙
    ...
    //超时时间全部默认为20秒
    private int connectTime = 20000;//连接超时时间
    private int readTime = 20000;//数据读取超时时间
    private int writeTime = 20000;//数据写入超时时间
    ...
    public OkhttpSet setHOST(String host) {
        this.host = host;
        return this;
    }
