...
public class InfoShowAdapter extends RecyclerView.Adapter<InfoShowAdapter.MyViewHolder>{
    ...
    public void setCheckItem(List<Integer> checkItem) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (checkItem.indexOf(position) != -1){
            holder.tv_info.setBackgroundResource(R.color.function_item_back);
        }else {
            holder.tv_info.setBackgroundColor(Color.TRANSPARENT);
        }
