...
public class FileInit {
    ...
    private String urlLogMessage = null;//log信息上传的接口
    ...
    public void writerContentToLogFile(final String content){
        if (FunctionSwitch.getLogSave() != 2 || !isPermission()) {
            return;
        }
    ...
    public void writerContentToCrashFile(final String content){
        if (FunctionSwitch.getCrashSave() != 2 || !isPermission()) {
            return;
        }
    ...
    public FileInit setFILE_LOG(String FILE_LOG) {
    ...
    public FileInit setFILE_CRASH(String FILE_CRASH) {
    ...
    public FileInit setUrlLog(String urlLog) {
        this.urlLog = urlLog;
        return this;
    }
    ...
    public FileInit setUrlCrash(String urlCrash) {
    ...
    public FileInit setRemoveFileDay(float removeFileDay) {
    ...
    public FileInit setFileCrash(File fileCrash) {
    ...
    public FileInit setFileLog(File fileLog) {
    ...
    public String getUrlLogMessage() {
        return urlLogMessage;
    }

    public FileInit setUrlLogMessage(String urlLogMessage) {
        this.urlLogMessage = urlLogMessage;
        return this;
    }
}
