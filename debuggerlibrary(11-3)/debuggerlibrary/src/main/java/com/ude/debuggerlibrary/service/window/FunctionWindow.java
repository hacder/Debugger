...
import com.ude.debuggerlibrary.activity.DebuggerSettingActivity;
import com.ude.debuggerlibrary.adpter.FunctionWindowAdapter;
...
public class FunctionWindow extends BaseWindow {
    ...
    private ResWindow resWindow;//资源占用窗口
    ...
    private FunctionWindow(Context context) {
        ...
        resWindow = ResWindow.getInstance(context);
    }
